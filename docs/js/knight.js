...
class Weapon{
	...
	input(input){
		switch(input){
			case "left": if(this.dir == "R"){this.erase(); this.x-=(this.w+50); this.dir = "L"}else{this.attack()}; break;
			case "right": if(this.dir == "L"){this.erase(); this.x+=(this.w+50); this.dir = "R"}else{this.attack()}; break;
		}
	}
